...
INTERFACE fld_perturb
   MODULE PROCEDURE         &
     ...
     fld_perturb_double_3d, &
     fld_perturb_double_4d 
END INTERFACE
...
CONTAINS
  ...
  END SUBROUTINE fld_perturb_double_0d
  
  SUBROUTINE fld_perturb_double_1d( fld_data, rperturb )
  ...
  END SUBROUTINE fld_perturb_double_1d
  
  !------------------------------------------------------------------------------
  
  SUBROUTINE fld_perturb_double_2d( fld_data, rperturb )
  ...
  END SUBROUTINE fld_perturb_double_2d
  
  !------------------------------------------------------------------------------
  
  SUBROUTINE fld_perturb_double_3d( fld_data, rperturb )
  ...
  END SUBROUTINE fld_perturb_double_3d

  !------------------------------------------------------------------------------
  
  SUBROUTINE fld_perturb_double_4d( fld_data, rperturb )
